...
class JDETracker(object):
    def __init__(self, opt, frame_rate=25):
        self.opt = opt
        if opt.gpus[0] >= 0:
    ...
    def update(self, im_blob, img0):
        ...
        # remain_min_area=(dets[:, 2]*dets[:, 3])>2500
        ...
        # vis
        # print(dets.shape)
        # pick=non_max_suppression(dets[:,[0,1,2,3]],0.85,dets[:,[4]].reshape(-1))
        # dets=dets[pick]
        # id_feature=id_feature[pick]
        # id_feature=id_feature[pick]
